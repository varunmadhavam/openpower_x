...
void Vsim::_settle__TOP__48(Vsim__Syms* __restrict vlSymsp) {
...
void Vsim::_settle__TOP__57(Vsim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsim::_settle__TOP__57\n"); );
    Vsim* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
