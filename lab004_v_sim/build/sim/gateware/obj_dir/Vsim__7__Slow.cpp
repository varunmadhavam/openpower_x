...
void Vsim::_settle__TOP__34(Vsim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsim::_settle__TOP__34\n"); );
...
void Vsim::_settle__TOP__36(Vsim__Syms* __restrict vlSymsp) {
