...
void Vsim::_settle__TOP__163(Vsim__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsim::_settle__TOP__163\n"); );
...
void Vsim::_settle__TOP__164(Vsim__Syms* __restrict vlSymsp) {
